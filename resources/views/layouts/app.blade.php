                            ...
                            .done(function (camdata)
                            {
                                ...
                                .done(function (cardata)
                                {
                                    for(var k =0; k < cardata.length; k++)
                                    {
                                        carevents.push
                                        ( {
                                            title: cardata[k].description,
                                            start: cardata[k].start_at,
                                            end: cardata[k].finish_at,
                                            name:cardata[k].user.name,
                                            role:cardata[k].user.roles.name,
                                            sub_role:cardata[k].user.subroles.name,
                                            description: cardata[k].description,
                                    ...
                                    $('#calendar').fullCalendar({
                                        ...
                                        eventSources: [roomevents,cameraevents,carevents],
