...
<!-- Modal -->
<div class="modal fade" id="driverModal" tabindex="-1" role="dialog" aria-labelledby="driverModalLabel" data-backdrop="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="driverModalLabel">กรอกรายละเอียดการจองพนักงานขับรถ</h4>
            </div>
            <div class="modal-body">
                ...
                <form method="post" action="/driver/create">
